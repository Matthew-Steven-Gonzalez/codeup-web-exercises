...
let percent = parseFloat(prompt("What percentage do you want to tip? "));

let total = parseFloat(prompt("What is the total of the bill?"));

let tip = calculateTip( percent, total);

alert(" You should tip $" + tip + " on your $" + total+ " bill. " );
