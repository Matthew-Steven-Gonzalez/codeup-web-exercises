...
document.getElementById('importanter-circle').addEventListener('click', function() {
    this.style = 'background-image: url(img/lec/img/europa.webp); background-size: cover;';
});

// With jQuery, we can do it even easier!

$('#important-circle').click(function() {
    $(this).css('background-image','url(img/lec/img/io.png)').css('background-size','cover');
});
...
$('.grandma').hover(function() {
    $(this).css('background-image','url(img/lec/img/jupiter-coin.webp)');
}, function() {
    $(this).css('background-image','url(img/lec/img/jupiter.webp)');
});
...
$('#submit').click(function(e) {
    ...
    console.log(val);
    if (val === 'pikachu') {
        $('#picture-example').html('<img class="push" src="img/lec/img/pikachu.gif" alt="pikachu gif">');
    } else if (val === 'dragonite') {
        $('#picture-example').html('<img class="push" src="img/lec/img/dragonite.gif" alt="dragonite gif">');
    } else {
        $('#picture-example').html('<img class="push" src="img/lec/img/you-were-close.png" alt="you were close">');
    }
});